    ...
    return (
        <div>
            ...
            <textarea
                ...
                rows={rows}
                className="w-full bg-[#121212]/50 text-gray-200 resize-none border border-[#0FF4C6] p-2 focus:ring-2 focus:ring-[#0FF4C6] focus:border-[#0FF4C6] transition-colors"
...
const SuggestionCard: React.FC<{ 
    ...
    <div className="bg-[#252525] p-4 border border-[#0FF4C6] flex flex-col justify-between space-y-3">
        <EditableField 
            label="HOOK" 
    ...
    <div className="space-y-4 flex flex-col">
      ...
      {isLoading && suggestions.length === 0 && (
         <div className="flex-grow flex items-center justify-center text-center text-gray-400 min-h-[100px]">
           <svg className="animate-spin h-8 w-8 text-[#0FF4C6]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
